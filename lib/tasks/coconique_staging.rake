namespace :coconique do
  namespace :staging do
    ...
    task doctor: :environment do
      ...
      checks << staging_check("cookie names", staging_env("SESSION_COOKIE_NAME") == "coconique_session" && staging_env("CSRF_COOKIE_NAME") == "coconique_csrf", "SESSION_COOKIE_NAME=#{staging_env("SESSION_COOKIE_NAME").presence || "(blank)"}, CSRF_COOKIE_NAME=#{staging_env("CSRF_COOKIE_NAME").presence || "(blank)"}")
